...
levels only'' replaced) had carried it to 427 words; the v20 panel compression, with the re-review round's two hedge additions (the projection-relative clause's upper-bound status; the cost sentence's zero-refinance-edge condition), has taken it to 244 words: the agent-based-model
