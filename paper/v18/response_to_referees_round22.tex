...
the purpose --- and nothing was de-hedged. The abstract went to 263 words. Two
deliberate additions have since taken it to 328 words: returning the agent-based model to
it, which the cut had orphaned against a section the model still occupies, and
reporting the lock-in contribution as a range rather than as a point (\S7). I would
