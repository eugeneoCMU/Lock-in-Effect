...
| C-77 | MAJOR | 3 | RUN | **RUN DONE, LANDING QUEUED** | run `89fe840` Branch A: additive phi* 0.755957 both floors, marginal +8.5194pp (4%) / +8.4858pp (4.991%) vs max +3.4680/+0.8979. E2/E3 PASS. Branch E's zero-literal fallback no longer needed. tab:assembly row not yet marked | RUN: re-solve the Aladangady reconciliation under the additive floor f |
