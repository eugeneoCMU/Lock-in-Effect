...
| C-78 | MAJOR | 3 | RUN | **RUN DONE, LANDING QUEUED** | run `544d571` Branch A: age_only between +0.3814pp of +4.1982 (9.1%); Limb A' +3.3692pp. E4/E5 PASS, E3 MISSED (60.63% collinearity, favourable). CAVEAT: the age-augmented CI [+0.602,+4.351] now COVERS the implied +0.9371. .tex not yet edited | RUN: re-run the episode gradient within narrow age bands |
