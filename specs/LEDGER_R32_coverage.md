...
| C-04 | CRITICAL | 2 | WORDING | **PARTIAL** | 66df169 (abstract site only; body sites open in C-formfork) | Label the 85.7% mechanical majority as form-conditional at every remai |
| C-05 | CRITICAL | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Qualify "binding layer" wherever it appears without the coverage-prope |
| C-06 | CRITICAL | 2 | STRUCTURE | **SATISFIED** | 2ec6a8e | Disclose the sampler's allocation rule and that the pool is not a prob |
| C-07 | CRITICAL | 3 | RUN | **OPEN** | wave 3 | RUN: post-stratify the 75,000-loan draw onto the SOMA coupon x vintage |
...
| C-15 | MAJOR | 1 | WORDING | **OPEN** | wave 1 | Restate the Ginnie–Freddie attribution on the window mean, not the May |
...
| C-18 | MAJOR | 2 | CHECK | **IN FIX PASS** | fix pass in flight | State the anchor-selection rule and show it against the five-read exte |
| C-19 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Promote the measured composed +2.9 cell into T1 and the abstract, or d |
| C-20 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | The ladder's stated selection rule selects a wider coverage-bearing ru |
| C-21 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | The Rademacher–Webb near-identity is not evidence of robustness |
| C-22 | MAJOR | 2 | CHECK | **IN FIX PASS** | fix pass in flight | Resolve the floor-form fork with a stated selection rule, and settle t |
| C-23 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | §VIII must state its policy conclusion as form-conditional, in the ope |
| C-24 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Relabel the binding interval with what is held fixed, and state the hi |
| C-25 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | State that no sampling error from the imported elasticity enters any l |
| C-26 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | State the Fannie comparison on one basis (or run the Fannie 2018-leg r |
| C-27 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Say plainly that the binding layer prices only the within-read compone |
| C-28 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Report the null's standalone recovery at 75/100 PSA beside the PSA spa |
...
| C-31 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Quote both denominators (the cap gap and the ex-ante expectations benc |
| C-32 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Name the mechanical-majority result as a fact about cap placement |
...
| C-36 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | State the scope condition the forced sign implies |
| C-37 | MAJOR | 2 | WORDING | **SATISFIED** | a978da7 | State the gate suite's domain in Appendix O ¶1 |
| C-38 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Strike "the monotone response across the Liebersohn–Rothstein band" fr |
| C-39 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Decide once whether the Ginnie and vintage overlays are corrections or |
| C-40 | MAJOR | 2 | CHECK | **IN FIX PASS** | fix pass in flight | State the assembly's inclusion rule (and, if it qualifies, add the att |
| C-41 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Attribute the assembly's one-directionality to its cause |
| C-42 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Stop ranking a measured institutional quantity against an unmeasured h |
| C-43 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Carry Batzer et al.'s ~$2.4trn to the comparison site |
| C-44 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Scope the "no outcome-holdout months exist anywhere, without exception |
| C-45 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Name the fiscal incidence of the 1-P wedge |
| C-46 | MAJOR | 2 | REFERENCE | **IN FIX PASS** | fix pass in flight | Add the missing ex-ante primary-rate offset to §VI.D's omission list |
...
| C-62 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Recast the open timing question as possibly ill-posed |
...
| C-67 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | State the design's resolution once and stop leaning on one-decimal end |
| C-68 | MAJOR | 2 | REFERENCE | **OPEN** | wave 2 | Recast the U.S. tax override as one reading, with the §108 exclusions  |
| C-69 | MAJOR | 2 | WORDING | **IN FIX PASS** | fix pass in flight | Say that a pre-committed externally-anchored member lies outside the q |
...
| C-98 | MINOR | 5 | REFERENCE | **OPEN** | wave 5 | Flag berger2026's working-paper status where its estimates are importe |
| C-99 | MINOR | 5 | WORDING | **OPEN** | wave 5 | Print the measured +3.7 at the age-standardized floor with the grid-re |
| C-100 | MINOR | 5 | WORDING | **OPEN** | wave 5 | Name the percentile rung's grid-exclusion convention and its 26/1,000  |
| C-101 | MINOR | 5 | WORDING | **OPEN** | wave 5 | Name the denominator of the width ratio |
...
| C-112 | MINOR | 5 | WORDING | **OPEN** | wave 5 | Derive the "$83 billion per CPR point" coefficient at first use |
...
| C-118 | MINOR | 5 | REFERENCE | **OPEN** | wave 5 | Say that the labor-reallocation leg is unquantified in this design |
| C-119 | MINOR | 5 | REFERENCE | **OPEN** | wave 5 | Connect the mobility constraint to the inventory channel and its incid |
| C-120 | MINOR | 5 | WORDING | **OPEN** | wave 5 | Name distributional silence about Ginnie Mae borrowers as a limitation |
...
- SATISFIED: **20**
- PARTIAL: 1
- SPEC COMMITTED, not run: 1
- IN FIX PASS (corrected edit sets being produced): 27
- OPEN: 77
- DEFERRED to Eugene: 7
- TOTAL: 133

## CRITICALs (13)

- **C-01** SATISFIED b26c1f6 — Soften or justify the abstract's newly-asserted "widest layer that does 
- **C-02** SATISFIED 6a34d5c — Disclose the floor read's actual support and correct tab:oosfloor's prov
- **C-03** SATISFIED 6a34d5c — State the clean leg's zero mature-age support and the unpriced age trans
- **C-04** PARTIAL 66df169 (abstract site only; body sites open in C-formfork) — Label the 85.7% mechanical majority as form-conditional at every remaini
- **C-05** IN FIX PASS — Qualify "binding layer" wherever it appears without the coverage-propert
- **C-06** SATISFIED 2ec6a8e — Disclose the sampler's allocation rule and that the pool is not a probab
- **C-07** OPEN — RUN: post-stratify the 75,000-loan draw onto the SOMA coupon x vintage-g
- **C-08** SPEC 01c4d58 + 8ce3da3 (spec committed, NOT run) — RUN: re-anchor h0 on Path A's estimated seasoning spline instead of the 
...
- **C-17** SATISFIED d1bf578 — Settle the +5.6 posture: drop the point and print the range, or state an
- **C-84** SATISFIED 6a34d5c — Give the 5.51% age-standardized and 5.52% Fannie reads their own labelle
- **C-132** EUGENE — EUGENE: the public Freddie loan-level parquet licensing question
