...
- **Vintage burnout failed a pre-committed test** (§20): survivor-selection burnout drove CPR to ~0% and trapped liquidity to 147% of empirical — wrong direction. Surface interpolation remains the production default.
